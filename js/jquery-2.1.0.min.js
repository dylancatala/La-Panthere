/*! jQuery v2.1.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function (
    ...
    o.extend({
      ...
      each: function (a, b, c) {
        var d,
          ...
          g = s(a);
        if (c) {
          if (g) for (; f > e && !1 !== (d = b.apply(a[e], c)); e++);
          else for (e in a) if (!1 === (d = b.apply(a[e], c))) break;
        } else if (g) for (; f > e && !1 !== (d = b.call(a[e], e, a[e])); e++);
        else for (e in a) if (!1 === (d = b.call(a[e], e, a[e]))) break;
        return a;
      },
      trim: function (a) {
      ...
      return (
        ...
        fb(function (f, g, h, i) {
          var j,
            ...
            r = c ? (e || (f ? a : o || d) ? [] : g) : q;
          if ((c && c(q, r, h, i), d))
            for (j = sb(r, n), d(j, [], h, i), k = j.length; k--;)
              (l = j[k]) && (r[n[k]] = !(q[n[k]] = l));
          if (f) {
            if (e || a) {
              if (e) {
  ...
  (o.filter = function (a, b, c) {
    ...
    o.fn.extend({
      find: function (a) {
        ...
        return (
          ((d = this.pushStack(c > 1 ? o.unique(d) : d)).selector = this
            .selector
            ? this.selector + " " + a
            : a),
          d
  ...
  !(function () {
    var a,
      b = m.createDocumentFragment().appendChild(m.createElement("div"));
  ...
  (o.event = {
      ...
      if (
        ((g = h = d = d || m),
          ...
          (q.indexOf(".") >= 0 &&
            ...
            ((b = b[o.expando]
              ? b
              : new o.Event(q, "object" == typeof b && b)).isTrigger = e ? 2 : 3),
            (b.namespace = r.join(".")),
            ...
            (n = o.event.special[q] || {}),
            e || !n.trigger || !1 !== n.trigger.apply(d, c)))
      ) {
        ...
        return (
          ...
          (n._default && !1 !== n._default.apply(p.pop(), c)) ||
          !o.acceptData(d) ||
          (k &&
            o.isFunction(d[q]) &&
            !o.isWindow(d) &&
    ...
    mouseHooks: {
      ...
      filter: function (a, b) {
        ...
        return (
          null == a.pageX &&
          null != b.clientX &&
          ((d = (c = a.target.ownerDocument || m).documentElement),
            (e = c.body),
            (a.pageX =
              b.clientX +
    ...
    o.fn.extend({
      on: function (a, b, c, d, e) {
        var f, g;
        if ("object" == typeof a) {
          for (g in ("string" != typeof b && ((c = c || b), (b = void 0)), a))
            this.on(g, b, c, a[g], e);
          return this;
        }
        if (
  ...
  (ib.optgroup = ib.option),
    ...
    o.extend({
      clone: function (a, b, c) {
        ...
        if (
          ...
          for (g = ob(h), d = 0, e = (f = ob(a)).length; e > d; d++)
            pb(f[d], g[d]);
        if (b)
          if (c)
            for (
    ...
    o.fn.extend({
      ...
      domManip: function (a, b) {
        ...
        if (
          k &&
          ((d = (c = o.buildFragment(a, this[0].ownerDocument, !1, this))
            .firstChild),
            1 === c.childNodes.length && (c = d),
            d)
        ) {
          for (g = (f = o.map(ob(c, "script"), kb)).length; k > j; j++)
            (h = c),
              j !== n &&
  ...
  o.extend({
    ...
    css: function (a, b, c, d) {
      ...
      return (
        ...
        "" === c || c
          ? ((f = parseFloat(e)), !0 === c || o.isNumeric(f) ? f || 0 : e)
          : e
      );
    }
  }),
  ...
  function Vb(a, b, c) {
    var d,
      ...
      p = L.get(a, "fxshow");
    for (d in (c.queue ||
      (null == (h = o._queueHooks(a, "fx")).unqueued &&
        ((h.unqueued = 0),
          (i = h.empty.fire),
      ...
      ((c.overflow = [m.overflow, m.overflowX, m.overflowY]),
        "none" === (j = o.css(a, "display")) && (j = tb(a.nodeName)),
        "inline" === j &&
        "none" === o.css(a, "float") &&
      ...
      return arguments.length
        ? ((d = o.isFunction(a)),
          this.each(function (c) {
            var e;
            1 === this.nodeType &&
              (null == (e = d ? a.call(this, c, o(this).val()) : a)
                ? (e = "")
                : "number" == typeof e
                  ? (e += "")
                  : o.isArray(e) &&
        ...
        select: {
          ...
          set: function (a, b) {
            for (
              ...
              ((d = e[g]).selected = o.inArray(o(d).val(), f) >= 0) && (c = !0);
    ...
    o.extend({
      ...
      ajax: function (a, b) {
        ...
        if (k.beforeSend && (!1 === k.beforeSend.call(l, v, k) || 2 === t))
          return v.abort();
        for (j in ((u = "abort"), { success: 1, error: 1, complete: 1 }))
          v[j](k[j]);
        if ((c = sc(oc, k, b, v))) {
          (v.readyState = 1),
              ...
              j
                ? (k.ifModified &&
                  ((w = v.getResponseHeader("Last-Modified")) &&
                    (o.lastModified[d] = w),
                    (w = v.getResponseHeader("etag")) && (o.etag[d] = w)),
                  204 === a || "HEAD" === k.type
                    ? (x = "nocontent")
                    : 304 === a
                      ? (x = "notmodified")
                      : ((x = u.state), (r = u.data), (j = !(s = u.error))))
